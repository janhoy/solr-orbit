...
from solrorbit.builder.downloaders.repositories.source_repository_provider import SourceRepositoryProvider
...
class SourceRepositoryProviderTest(TestCase):
    ...
    def test_initialize_repo_with_remote(self):
        ...
        self.source_repo_provider.path_manager.create_path.assert_has_calls([mock.call(self.host, self.target_dir, create_locally=False)])
        self.source_repo_provider.git_manager.clone.assert_has_calls([mock.call(self.host, self.remote_url, self.target_dir)])
    ...
    def test_update_repo_to_current(self):
        ...
        self.source_repo_provider.git_manager.assert_has_calls([mock.call.get_revision_from_local_repository(self.host, self.target_dir)])
    ...
    def test_update_repo_to_local_revision(self):
        ...
        self.source_repo_provider.git_manager.assert_has_calls(
            [mock.call.checkout(self.host, self.target_dir, "fake rev"), mock.call.get_revision_from_local_repository(self.host, self.target_dir)]
        )
