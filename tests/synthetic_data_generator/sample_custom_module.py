...
GEOGRAPHIC_CLUSTERS = {
    ...
    "Brooklyn": {"center": {"lat": 40.6782, "lon": -73.9442}, "radius": 0.05},
    "Austin": {
...
def generate_synthetic_document(providers, **custom_lists):
    ...
    document = {
        ...
        "earnings": {
            "today": {"amount": generic.numeric.float_number(start=1.0, end=5.0, precision=2), "currency": "USD"},
            "this_week": {"amount": generic.numeric.float_number(start=1.0, end=5.0, precision=2), "currency": "USD"},
            "this_month": {"amount": generic.numeric.float_number(start=1.0, end=5.0, precision=2), "currency": "USD"},
        },
        "last_grooming_check": "2023-12-01",
        "owner": {"first_name": first_name, "last_name": last_name, "email": f"{first_name}{last_name}@gmail.com"},
