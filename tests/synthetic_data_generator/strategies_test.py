...
class TestCustomStrategy:
        ...
        loaded_sdg_config = {
            ...
            "CustomGenerationValues": {
                "custom_lists": {
                    ...
                    "license_plates": ["WOOF101", "BARKATAMZN"],
                    "tips": ["biscuits", "cash"],
                    "skills": ["sniffing", "squirrel_chasing", "bite_tail", "smile"],
                    "vehicle_types": ["sedan", "suv", "truck"],
                    "vehicle_makes": ["toyta", "honda", "nissan"],
                    "vehicle_models": ["rav4", "accord", "murano"],
                    "vehicle_years": [2012, 2015, 2019],
                    "vehicle_colors": ["white", "red", "blue", "black", "silver"],
    ...
    def sample_docs_generated(self):
        return [
            {
                "dog_driver_id": "DD4444",
                "dog_name": "Hana",
                "dog_breed": "Korean Jindo",
                "license_number": "BARKATAMZN6176",
                "favorite_treats": "pup_cup",
                "preferred_tip": "cash",
                "vehicle_type": "truck",
                "vehicle_make": "honda",
                "vehicle_model": "murano",
                "vehicle_year": 2019,
                "vehicle_color": "black",
                "license_plate": "WOOF101",
                "current_location": {"lat": 40.73389901726337, "lon": -73.95726095278667},
                "status": "available",
                "current_ride": "R922315",
                "account_status": "inactive",
                "join_date": "05/01/2017",
                "total_rides": 166,
                "rating": 1.91,
                ...
                "owner": {"first_name": "Elfrieda", "last_name": "Huffman", "email": "ElfriedaHuffman@gmail.com"},
                "special_skills": ["bite_tail", "bite_tail", "smile"],
                "bark_volume": 9.33,
                "tail_wag_speed": 4.5,
            },
            {
                "dog_driver_id": "DD2495",
                "dog_name": "Luna",
                "dog_breed": "Chihuahua",
                "license_number": "WOOF1014472",
                "favorite_treats": "jerky",
                "preferred_tip": "cash",
                "vehicle_type": "sedan",
                "vehicle_make": "nissan",
                "vehicle_model": "murano",
                ...
                "license_plate": "WOOF101",
                "current_location": {"lat": 40.75654230013213, "lon": -73.98178219702368},
                "status": "busy",
                "current_ride": "R690202",
                "account_status": "active",
                "join_date": "03/06/2018",
                "total_rides": 24,
                "rating": 2.13,
                "earnings": {"today": {"amount": 1.4, "currency": "USD"}, "this_week": {"amount": 3.89, "currency": "USD"}, "this_month": {"amount": 4.88, "currency": "USD"}},
                "last_grooming_check": "2023-12-01",
                "owner": {"first_name": "Avery", "last_name": "Moran", "email": "AveryMoran@gmail.com"},
                "special_skills": ["sniffing", "bite_tail", "smile"],
                "bark_volume": 1.73,
                "tail_wag_speed": 9.1,
            },
            {
                "dog_driver_id": "DD2223",
                "dog_name": "Youpie",
                "dog_breed": "Boxer",
                "license_number": "BARKATAMZN7147",
                "favorite_treats": "jerky",
                "preferred_tip": "cash",
                "vehicle_type": "suv",
                "vehicle_make": "nissan",
                ...
                "vehicle_year": 2015,
                "vehicle_color": "white",
                "license_plate": "BARKATAMZN",
                "current_location": {"lat": 30.212385699598567, "lon": -97.76458615057449},
                "status": "available",
                "current_ride": "R303297",
                "account_status": "inactive",
                "join_date": "03/25/2025",
                "total_rides": 110,
                "rating": 1.58,
                "earnings": {"today": {"amount": 2.98, "currency": "USD"}, "this_week": {"amount": 2.71, "currency": "USD"}, "this_month": {"amount": 4.89, "currency": "USD"}},
                "last_grooming_check": "2023-12-01",
                "owner": {"first_name": "Otto", "last_name": "Stephens", "email": "OttoStephens@gmail.com"},
                "special_skills": ["sniffing", "squirrel_chasing", "bite_tail"],
                "bark_volume": 7.09,
                "tail_wag_speed": 7.2,
            },
        ]
    ...
    def mock_sdg_config(self):
        ...
        loaded_sdg_config = {
            ...
            "MappingGenerationValues": {
                ...
                "field_overrides": {
                    "id": {"generator": "generate_keyword", "params": {"choices": ["Helly R", "Mark S", "Irving B"]}},
    ...
    def complex_opensearch_index_mapping(self):
        return {
                ...
                "properties": {
                    "user": {
                        ...
                        "properties": {
                            "id": {"type": "keyword"},
                            "email": {"type": "keyword"},
                            "name": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}, "completion": {"type": "completion"}}, "analyzer": "standard"},
                            "address": {
                                "type": "object",
                                "properties": {
                                    "street": {"type": "text"},
                    ...
                    "activity_log": {
                        "type": "nested",
                        "properties": {"timestamp": {"type": "date"}, "action": {"type": "keyword"}, "ip_address": {"type": "ip"}, "details": {"type": "object", "enabled": False}},
                    },
                    "metadata": {
                        "type": "object",
                        "properties": {
                    ...
                    "description": {
                        "type": "text",
                        "analyzer": "english",
                        "fields": {"keyword": {"type": "keyword", "ignore_above": 256}, "standard": {"type": "text", "analyzer": "standard"}},
                    },
                    "ranking_scores": {"type": "object", "properties": {"popularity": {"type": "float"}, "relevance": {"type": "float"}, "quality": {"type": "float"}}},
            ...
            "settings": {
                ...
                "analysis": {"analyzer": {"email_analyzer": {"type": "custom", "tokenizer": "uax_url_email", "filter": ["lowercase", "stop"]}}},
            },
        }
        ...
        return [
            {
                "user": {
                    ...
                    "address": {
                        ...
                        "state": "sasuke",
                        "zip": "naruto",
                        "location": {"lat": 26.99576279125438, "lon": -106.55835561335948},
                    },
                    "preferences": {},
                },
                "orders": [
                    {
                        ...
                        "status": "naruto",
                        "items": [
                            {"product_id": "sasuke", "name": "ipsum Sample text for 5", "quantity": 19395, "price": 0.31, "categories": "sakura"},
                            {"product_id": "sakura", "name": "lorem Sample text for 94", "quantity": -5488, "price": 0.76, "categories": "sasuke"},
                        ],
                        "shipping_address": {
                            ...
                            "state": "sasuke",
                            "zip": "sakura",
                            "location": {"lat": 40.62216376082151, "lon": -65.29355206583621},
                        },
                    },
                    {
                        "id": "sakura",
                        ...
                        "amount": "unknown_type",
                        "status": "sasuke",
                        "items": [{"product_id": "sakura", "name": "lorem Sample text for 100", "quantity": -1063, "price": 0.11, "categories": "sakura"}],
                        "shipping_address": {
                            "street": "lorem Sample text for 72",
                            "city": "sasuke",
                            "state": "naruto",
                            "zip": "sasuke",
                            "location": {"lat": 64.92051504356562, "lon": -64.90676398234942},
                        },
                    },
                    {
                        "id": "naruto",
                        ...
                        "status": "sasuke",
                        "items": [
                            {"product_id": "sasuke", "name": "lorem Sample text for 5", "quantity": -27595, "price": 0.73, "categories": "sasuke"},
                            {"product_id": "sasuke", "name": "ipsum Sample text for 8", "quantity": 3581, "price": 0.65, "categories": "naruto"},
                        ],
                        "shipping_address": {
                            ...
                            "state": "sakura",
                            "zip": "naruto",
                            "location": {"lat": -48.34559264417752, "lon": -178.36558923535966},
                        },
                    },
                ],
                "activity_log": [
                    {"timestamp": "2021-09-22", "action": "sakura", "ip_address": "101.52.247.55", "details": {}},
                    {"timestamp": "2022-01-22", "action": "sasuke", "ip_address": "44.189.12.245", "details": {}},
                    {"timestamp": "2022-07-03", "action": "naruto", "ip_address": "131.232.186.58", "details": {}},
                ],
                "metadata": {"created_at": "2022-02-09", "updated_at": "2022-04-18", "tags": "sasuke", "source": "sasuke", "version": 6},
                "description": "lorem Sample text for 46",
                "ranking_scores": {"popularity": 0.89, "relevance": 0.79, "quality": 0.95},
                "permissions": [{"user_id": "sasuke", "role": "naruto", "granted_at": "2022-09-18"}],
            },
            {
                "user": {
                    "id": "naruto",
                    ...
                    "address": {
                        ...
                        "state": "naruto",
                        "zip": "naruto",
                        "location": {"lat": 18.716170289552792, "lon": 26.676759590182087},
                    },
                    "preferences": {},
                },
                "orders": [
                    {
                        ...
                        "amount": "unknown_type",
                        "status": "sasuke",
                        "items": [{"product_id": "naruto", "name": "ipsum Sample text for 72", "quantity": 8096, "price": 0.98, "categories": "sasuke"}],
                        "shipping_address": {
                            "street": "ipsum Sample text for 70",
                            "city": "sasuke",
                            "state": "naruto",
                            "zip": "sasuke",
                            "location": {"lat": 35.160379130894796, "lon": 142.70658997708557},
                        },
                    },
                    {
                        "id": "sasuke",
                        ...
                        "status": "sasuke",
                        "items": [
                            {"product_id": "sakura", "name": "ipsum Sample text for 95", "quantity": -26888, "price": 0.9, "categories": "sasuke"},
                            {"product_id": "sakura", "name": "lorem Sample text for 77", "quantity": -4878, "price": 0.68, "categories": "sakura"},
                            {"product_id": "sasuke", "name": "lorem Sample text for 60", "quantity": 3465, "price": 0.92, "categories": "sakura"},
                        ],
                        "shipping_address": {
                            "street": "ipsum Sample text for 69",
                            "city": "sakura",
                            "state": "sasuke",
                            "zip": "sakura",
                            "location": {"lat": -10.880093403565638, "lon": -167.79823045612983},
                        },
                    },
                    {
                        "id": "sasuke",
                        ...
                        "status": "sakura",
                        "items": [
                            {"product_id": "sakura", "name": "lorem Sample text for 55", "quantity": -22916, "price": 0.29, "categories": "naruto"},
                            {"product_id": "sasuke", "name": "lorem Sample text for 72", "quantity": -5256, "price": 0.45, "categories": "naruto"},
                        ],
                        "shipping_address": {
                            ...
                            "state": "naruto",
                            "zip": "sasuke",
                            "location": {"lat": 89.19863809212737, "lon": 114.09913348615743},
                        },
                    },
                ],
                "activity_log": [{"timestamp": "2020-06-26", "action": "naruto", "ip_address": "139.179.72.223", "details": {}}],
                "metadata": {"created_at": "2020-02-11", "updated_at": "2021-05-25", "tags": "sasuke", "source": "sakura", "version": 16},
                "description": "ipsum Sample text for 8",
                "ranking_scores": {"popularity": 0.16, "relevance": 0.06, "quality": 0.72},
                "permissions": [
                    {"user_id": "sakura", "role": "sasuke", "granted_at": "2020-01-23"},
                    {"user_id": "sasuke", "role": "naruto", "granted_at": "2022-11-19"},
                    {"user_id": "sakura", "role": "naruto", "granted_at": "2021-07-06"},
                ],
            },
            {
                "user": {
                    ...
                    "address": {
                        ...
                        "state": "sasuke",
                        "zip": "sakura",
                        "location": {"lat": 32.588564110838846, "lon": -23.052179676898845},
                    },
                    "preferences": {},
                },
                "orders": [
                    {
                        ...
                        "amount": "unknown_type",
                        "status": "sasuke",
                        "items": [{"product_id": "sasuke", "name": "ipsum Sample text for 63", "quantity": 7348, "price": 0.37, "categories": "sasuke"}],
                        "shipping_address": {
                            "street": "ipsum Sample text for 34",
                            "city": "naruto",
                            "state": "sakura",
                            "zip": "sasuke",
                            "location": {"lat": -51.05656520056002, "lon": -17.084501461214813},
                        },
                    },
                    {
                        "id": "sakura",
                        ...
                        "status": "sasuke",
                        "items": [
                            {"product_id": "naruto", "name": "ipsum Sample text for 43", "quantity": 28814, "price": 0.91, "categories": "sakura"},
                            {"product_id": "sasuke", "name": "ipsum Sample text for 80", "quantity": -293, "price": 0.52, "categories": "naruto"},
                            {"product_id": "sakura", "name": "ipsum Sample text for 72", "quantity": -31854, "price": 0.54, "categories": "sakura"},
                        ],
                        "shipping_address": {
                            ...
                            "state": "sasuke",
                            "zip": "sasuke",
                            "location": {"lat": 40.539565425667945, "lon": 59.77455111107835},
                        },
                    },
                ],
                "activity_log": [{"timestamp": "2021-04-14", "action": "sakura", "ip_address": "155.140.52.23", "details": {}}],
                "metadata": {"created_at": "2021-06-22", "updated_at": "2020-09-06", "tags": "naruto", "source": "naruto", "version": 9},
                "description": "ipsum Sample text for 55",
                "ranking_scores": {"popularity": 0.49, "relevance": 0.23, "quality": 0.32},
                "permissions": [{"user_id": "sakura", "role": "sasuke", "granted_at": "2020-07-29"}, {"user_id": "naruto", "role": "sasuke", "granted_at": "2021-01-19"}],
            },
        ]
...
class TestMappingConverter:
    ...
    def test_generating_documents_for_with_overrides(self, mapping_converter):
        basic_mappings = {"properties": {"id": {"type": "keyword"}, "amount": {"type": "float"}, "created_at": {"type": "date"}, "status": {"type": "keyword"}}}
    ...
    def test_generate_sparse_vector(self, mapping_converter):
        ...
        mapping = {"properties": {"sparse_embedding": {"type": "sparse_vector"}}}
    ...
    def test_generate_sparse_vector_with_params(self, mapping_converter):
        ...
        mapping_converter.mapping_config = {
            "generator_overrides": {"sparse_vector": {"num_tokens": 5, "min_weight": 0.1, "max_weight": 0.9, "token_id_start": 5000, "token_id_step": 50}},
            "field_overrides": {},
        }

        mapping = {"properties": {"embedding": {"type": "sparse_vector"}}}
    ...
    def test_generate_sparse_vector_in_complex_mapping(self, mapping_converter):
        ...
        mapping = {
            "properties": {
                ...
                "metadata": {"type": "object", "properties": {"id": {"type": "keyword"}}},
            }
        }
